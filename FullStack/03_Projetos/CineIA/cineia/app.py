...
with st.sidebar:
 ...
 ["Ação", "Drama", "Sci-Fi", "Comédia", "Terror", "Documentário", "Ficção Cientifica", "Romance", "Religioso", "Filmes internacionais"])
 tempo = st.slider("Duração máxima (minutos):", 60,180, 240, 120)
 ...
 if not mood:
    ...
    with st.spinner("Analisando catálogo cinematográfico..."):
        prompt = f"""
                    ...
                    Recomende 10 filmes para alguém que gosta de {', '.join(genero)} e que durem até {tempo}
                    minutos.
                    O usuário descreveu o clima do filme como: '{mood}'.
                    Para cada filme, forneça: Título, Ano, Gênero, Autores e uma frase curta do porquê combina com o pedido.
                    """
